...
export class ReportController {
   ...
   */
  @ApiOperation({ summary: 'Get full session report for one participant attempt' })
  @ApiParam({ name: 'assessmentId', description: 'The UUID of the assessment', example: '123e4567-e89b-12d3-a456-426614174000' })
  @ApiParam({ name: 'sessionId', description: 'The UUID of the session', example: '123e4567-e89b-12d3-a456-426614174001' })
  @ApiResponse({ status: 200, description: 'Full session report retrieved successfully' })
  @Get('assessments/:assessmentId/sessions/:sessionId/report')
  getSessionReport(
   ...
   */
  @ApiOperation({ summary: 'Get aggregated report for all participants in an assessment' })
  @ApiParam({ name: 'assessmentId', description: 'The UUID of the assessment', example: '123e4567-e89b-12d3-a456-426614174000' })
  @ApiResponse({ status: 200, description: 'Aggregated assessment report retrieved successfully' })
  @Get('assessments/:assessmentId/report')
  getAssessmentReport(
    @Param('assessmentId', ParseUUIDPipe) assessmentId: string,
  ...
  @ApiParam({ name: 'participantId', description: 'The UUID of the participant', example: '123e4567-e89b-12d3-a456-426614174002' })
  @ApiResponse({ status: 200, description: 'Participant report retrieved successfully' })
  @Get('participants/:participantId/report')
