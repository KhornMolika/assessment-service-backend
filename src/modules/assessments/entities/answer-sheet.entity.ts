// -----------------------------------------------------------------------------
// One attempt per participant per assessment.
// selectedQuestionIds only populated for DYNAMIC assessments —
// stores which questions this specific participant was given.
// -----------------------------------------------------------------------------
import {
  Entity,
  Column,
