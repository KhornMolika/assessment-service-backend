...
describe('AssessmentsService', () => {
  ...
  describe('findAll', () => {
    it('should return paginated assessments', async () => {
      ...
      const result = await service.findAll('topic-1', {
        page: 1,
        limit: 10,
      } as any);
      ...
      assessmentQuestionsMock.findByAssessment!.mockResolvedValue([
        {
          id: 'aq1',
          questionId: 'q1',
          question: { questionText: 'Q1' } as any,
        },
      ]);
      assessmentsMock.findOneWithDetails!.mockResolvedValue({
        id: '1',
  ...
  describe('archive', () => {
    ...
    it('should archive successfully if PUBLISHED', async () => {
      assessmentsMock.findOneWithStatus!.mockResolvedValue({
        id: '1',
      } as unknown as Assessment);
      assessmentsMock.findOneWithDetails!.mockResolvedValue({
        id: '1',
  ...
  describe('addQuestion', () => {
    it('should throw NotFoundException if question not found', async () => {
      ...
      await expect(
        service.addQuestion('1', { questionId: 'q1' }),
    ...
    it('should add question successfully', async () => {
      ...
      assessmentQuestionsMock.save!.mockResolvedValue({
        id: 'aq1',
        points: 10,
      });
  ...
  describe('removeQuestion', () => {
    it('should throw ConflictException if not DRAFT', async () => {
      ...
      await expect(service.removeQuestion('1', 'aq1')).rejects.toThrow(
        ConflictException,
      );
    });
    ...
    it('should remove question', async () => {
      ...
      expect(assessmentQuestionsMock.softDelete).toHaveBeenCalledWith({
        id: 'aq1',
      });
    });
  });
  ...
  describe('updateSettings', () => {
    it('should update settings', async () => {
      ...
      await service.updateSettings('1', { mode: Mode.REAL_TIME });
      expect(assessmentSettingsMock.update).toHaveBeenCalledWith(
        { id: 's1' },
        expect.objectContaining({ mode: Mode.REAL_TIME }),
      );
    });
    ...
    it('should throw BadRequestException if DYNAMIC and rules missing', async () => {
      ...
      await expect(
        service.updateSettings('1', {
          questionSelection: QuestionSelection.DYNAMIC,
        } as any),
  ...
  describe('addQuestions', () => {
    ...
    it('should throw ConflictException if duplicate questionIds in request', async () => {
      ...
      await expect(
        service.addQuestions('1', [{ questionId: 'q1' }, { questionId: 'q1' }]),
      ).rejects.toThrow(ConflictException);
    });
  });
  ...
  describe('replaceQuestions', () => {
    ...
    it('should throw NotFoundException if any question is missing', async () => {
      ...
      await expect(
        service.replaceQuestions('1', { questionIds: ['q1'] }),
      ).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('getParticipants', () => {
    it('should return paginated participants', async () => {
      ...
      const res = await service.getParticipants('1', {
        page: 1,
        limit: 10,
      } as any);
  ...
  describe('removeParticipant', () => {
    it('should remove participant successfully', async () => {
      ...
      expect(assessmentParticipantsMock.softDelete).toHaveBeenCalledWith({
        id: 'ap1',
      });
    });
    ...
    it('should throw NotFoundException if participant not found', async () => {
      ...
      await expect(service.removeParticipant('1', 'p1')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
