...
export class ClientResponseDto {
  ...
  @ApiProperty({
    ...
    description: 'Public facing client ID',
  })
  clientId!: string;
  @Expose()
  @ApiProperty({ example: 'Acme Corp', description: 'Client display name' })
  name!: string;
  @Expose()
  @ApiProperty({
    example: 'acme-corp',
...
export class ClientCreatedResponseDto extends ClientResponseDto {
  ...
  @ApiProperty({
    example: 'sec_xyz789',
    description: 'Raw secret — shown once, store securely',
  })
  clientSecret!: string;
}
