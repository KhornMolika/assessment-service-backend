...
export class AutoMigration1779331733745 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."question_type_enum" AS ENUM('SINGLE_CHOICE', 'MULTIPLE_CHOICE', 'TRUE_FALSE', 'ORDERING', 'FILL_IN_THE_BLANK', 'MATCHING', 'RATING', 'SHORT_ANSWER', 'ESSAY')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."assessment_setting_mode_enum" AS ENUM('SELF_PACED', 'REAL_TIME')`);
        await queryRunner.query(`CREATE TYPE "public"."assessment_setting_questionselection_enum" AS ENUM('MANUAL', 'DYNAMIC')`);
        await queryRunner.query(`CREATE TYPE "public"."assessment_setting_participantidentity_enum" AS ENUM('ANONYMOUS', 'AUTHENTICATED', 'EXTERNAL')`);
        await queryRunner.query(`CREATE TYPE "public"."assessment_setting_showresults_enum" AS ENUM('IMMEDIATELY', 'MANUAL', 'NEVER')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_85253fcc97323d6cf996662f5e" ON "assessment_setting" ("clientId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."ai_grading_job_status_enum" AS ENUM('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."answer_sheet_status_enum" AS ENUM('IN_PROGRESS', 'SUBMITTED', 'GRADED', 'REQUIRES_REVIEW')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."assessment_participant_status_enum" AS ENUM('PENDING', 'IN_PROGRESS', 'COMPLETED', 'ABSENT')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."assessment_type_enum" AS ENUM('QUIZ', 'EXAM', 'SURVEY', 'PRACTICE')`);
        ...
        await queryRunner.query(`ALTER TABLE "answer_sheet" ADD CONSTRAINT "FK_87ade9b5414347879f983acd981" FOREIGN KEY ("assessmentId") REFERENCES "assessment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "answer_sheet" DROP CONSTRAINT "FK_87ade9b5414347879f983acd981"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."assessment_participant_status_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_85253fcc97323d6cf996662f5e"`);
