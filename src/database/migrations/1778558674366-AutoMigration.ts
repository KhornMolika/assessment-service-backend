...
export class AutoMigration1778558674366 implements MigrationInterface {
    name = 'AutoMigration1778558674366'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."question_bank_visibility_enum" AS ENUM('PRIVATE', 'PUBLIC')`);
        await queryRunner.query(`CREATE TABLE "question_bank" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" character varying NOT NULL, "name" character varying(256) NOT NULL, "description" text, "tags" text array, "visibility" "public"."question_bank_visibility_enum" NOT NULL DEFAULT 'PRIVATE', CONSTRAINT "PK_ddf9cd18bcda25d31e7ef21b519" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_df5ece6f12d072f11a1e24048b" ON "question_bank" ("clientId") `);
        await queryRunner.query(`CREATE TABLE "participant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" character varying NOT NULL, "assessmentId" character varying NOT NULL, "email" character varying, "phone" character varying, "name" character varying, CONSTRAINT "PK_64da4237f502041781ca15d4c41" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "bank_topic" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" character varying NOT NULL, "questionBankId" character varying NOT NULL, "topicId" character varying NOT NULL, CONSTRAINT "PK_36bd39126880697e80eb007055c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "refresh_token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" uuid NOT NULL, "tokenHash" character varying NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "isRevoked" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_b575dd3c21fb0831013c909e7fe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f6f07caa0ec6df39d56b0aa9f6" ON "refresh_token" ("clientId") `);
        await queryRunner.query(`CREATE TABLE "client" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "slug" character varying NOT NULL, "clientId" character varying NOT NULL, "clientSecretHash" character varying NOT NULL, "allowedOrigins" text array, "scopes" text array, "webhookUrl" character varying, "webhookSecret" character varying, CONSTRAINT "UQ_3ce23f3709983d19bc42758b01e" UNIQUE ("slug"), CONSTRAINT "UQ_6ed9067942d7537ce359e172ff6" UNIQUE ("clientId"), CONSTRAINT "PK_96da49381769303a6515a8785c7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."assessment_status_enum" AS ENUM('DRAFT', 'PUBLISHED', 'ARCHIVED')`);
        await queryRunner.query(`CREATE TABLE "assessment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" character varying NOT NULL, "name" character varying NOT NULL, "description" text, "status" "public"."assessment_status_enum" NOT NULL DEFAULT 'DRAFT', CONSTRAINT "PK_c511a7dc128256876b6b1719401" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ai_grading_config" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "questionId" character varying NOT NULL, "rubric" jsonb NOT NULL, "instruction" text NOT NULL, "maxScore" double precision NOT NULL, CONSTRAINT "PK_965339fd6c2bf29b05578124a12" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "assessments_questions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "assessmentId" character varying NOT NULL, "questionId" character varying NOT NULL, "order" integer NOT NULL, "pointsOverride" double precision, "snapshot" jsonb, CONSTRAINT "PK_e0ad116d6e77090468e8d4e01db" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ai_grading_job" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "entryId" character varying NOT NULL, "configId" character varying NOT NULL, "status" "public"."ai_grading_job_status_enum" NOT NULL DEFAULT 'QUEUED', "modelUsed" character varying, "score" double precision, "confidence" integer, "feedback" text, "errorMessage" text, "attemptCount" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_0ab9a8b84e749d0194c0176df4e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "topic" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" character varying NOT NULL, "name" character varying(256) NOT NULL, "slug" character varying(256) NOT NULL, "description" text, CONSTRAINT "PK_33aa4ecb4e4f20aa0157ea7ef61" PRIMARY KEY ("id"))`);
